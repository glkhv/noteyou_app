...
```
> Данный метод запуска проекта проверен исключительно на Windows. На системах Linux проект может запускаться иначе. Команда разработки использовала Windows.
